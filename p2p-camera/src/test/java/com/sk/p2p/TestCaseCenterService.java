...
public class TestCaseCenterService {
    private static Logger logger = LoggerFactory.getLogger(TestCaseCenterService.class);
...
//        String post = bean.post("http://47.95.238.222:8080/api/v1/hospital/findById", params);
        String post = bean.post("http://127.0.0.1:8080/api/v1/caseCenter/selectAll", params);
        try {
